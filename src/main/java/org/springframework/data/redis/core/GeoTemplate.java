...
/**
 * Redis 地理位置操作模板类，基于 {@link RedisTemplate} 的 Geo 操作封装。
 * <p>
 * 提供了地理位置相关的便捷操作方法，包括：
 * <ul>
 *   <li>坐标添加：{@link #geoAdd(String, double, double)}</li>
 *   <li>距离计算：{@link #distance(String, String)}、{@link #getDistance(double, double, double, double)}</li>
 *   <li>范围查询：{@link #getCircleUsersByDistance(String, double)}、{@link #getCircleUsersByRadius(String, double)}</li>
...
public class GeoTemplate extends AbstractOperations<String, Object>  {
	...
	/**
	 * 构造 GeoTemplate 实例，使用 {@link RedisKey#GEO_LOCATION_KEY} 作为默认的地理位置 Key
	 *
